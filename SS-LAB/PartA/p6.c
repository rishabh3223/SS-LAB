...
void main()
{
	...
	strcpy(macroname,"");
	f1=fopen("inputmac.txt","r");
	f2=fopen("outputmac.txt","w");
	...
	printf("\nOutput file generated as outputmac.txt and DEFTAB as deftabmac.txt\n");
